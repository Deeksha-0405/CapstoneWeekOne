package com.aem.enablement.core.servlets;
...
public class QueryBuilderServlet extends SlingSafeMethodsServlet {
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
		...
		try {
			 ...
			 */
			predicate.put("path", "/content/enablementCapstone/us/en/article");
			predicate.put("type", "cq:page");
			predicate.put("property", "jcr:content/cq:template");
			predicate.put("property.value", "/conf/enablementCapstone/settings/wcm/templates/article-page");
			predicate.put("orderby", "@jcr:content/jcr:created");
